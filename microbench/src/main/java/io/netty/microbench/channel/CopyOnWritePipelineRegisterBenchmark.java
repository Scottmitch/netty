...
public class CopyOnWritePipelineRegisterBenchmark extends AbstractMicrobenchmark {
    ...
    public void setup() {
        ...
        cowPipeline.addFirst(new TestInboundHandler(cowCount));
        cowPipeline.addFirst(new TestInboundHandler(cowCount));
        cowPipeline.addFirst(new ChannelOutboundHandlerAdapter() { });
        cowPipeline.addFirst(new TestInboundHandler(cowCount));

        oldCount = new MutableInteger();
        oldPipeline.addFirst(new TestInboundHandler(oldCount));
        oldPipeline.addFirst(new TestInboundHandler(oldCount));
        oldPipeline.addFirst(new ChannelOutboundHandlerAdapter() { });
        oldPipeline.addFirst(new TestInboundHandler(oldCount));
    }
